# HIPAA Mappings to Provata Health Controls

Below is a list of HIPAA Safeguards and Requirements and the Provata Health controls in place to meet those.

| **Administrative Controls** HIPAA Rule | Provata Health Control
--- | ---
...
| **Physical Safeguards** HIPAA Rule | Provata Health Control
--- | ---
...
| **Technical Safeguards** HIPAA Rule | Provata Health Control
---------------- | ----------------
