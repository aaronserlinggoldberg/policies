...
4. All policies are made accessible to all Provata Health workforce members. The current master policies are published [here](https://catalyze.io/policy/).
...
7. Provata Health utilizes the HITRUST MyCSF framework to track compliance with the HITRUST CSF on an annual basis. Provata Health also tracks compliance with HIPAA and publishes results [here](https://catalyze.io/hipaa/).
